...
export class AddInvalidAttemptsColumnToMfaTable1593967659898 implements MigrationInterface {
    name = 'AddInvalidAttemptsColumnToMfaTable1593967659898'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "mfa" ADD "invalidAttempts" integer NOT NULL DEFAULT 0`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "local-login" ADD CONSTRAINT "FK_60523794271ca8bcaf8b5418155" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "mfa" DROP COLUMN "invalidAttempts"`, undefined);
    }
