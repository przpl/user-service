...
export class Init1586185211485 implements MigrationInterface {
    name = 'Init1586185211485'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "user" ("id" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "confirmation" ("subject" character varying NOT NULL, "userId" character varying NOT NULL, "code" character varying NOT NULL, "type" smallint NOT NULL, "sentCount" smallint NOT NULL DEFAULT 0, "lastSendRequestAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1ad9223c7afa72c4c484d36b28a" PRIMARY KEY ("subject"))`, undefined);
        await queryRunner.query(`CREATE TABLE "external-login" ("externalUserId" character varying NOT NULL, "provider" smallint NOT NULL, "userId" character varying NOT NULL, "email" character varying, CONSTRAINT "PK_9389ea09942ea0b6883445365f4" PRIMARY KEY ("externalUserId", "provider"))`, undefined);
