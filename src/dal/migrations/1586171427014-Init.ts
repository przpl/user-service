...
export class Init1586171427014 implements MigrationInterface {
    name = 'Init1586171427014'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "confirmation" ("subject" character varying NOT NULL, "type" smallint NOT NULL, "userId" character varying NOT NULL, "code" character varying NOT NULL, "sentCount" smallint NOT NULL DEFAULT 0, "lastSendRequestAt" TIMESTAMP NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e49053dfc8e419a45104c33ba12" PRIMARY KEY ("subject", "type"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "local-login" ("userId" character varying NOT NULL, "username" character varying, "email" character varying, "emailConfirmed" boolean NOT NULL DEFAULT false, "phoneCode" character varying, "phoneNumber" character varying, "phoneConfirmed" boolean NOT NULL DEFAULT false, "passwordHash" character varying, CONSTRAINT "UQ_4d3649d6bfcce4413a378e39c54" UNIQUE ("username"), CONSTRAINT "UQ_636129349aa7b4d483f07838f05" UNIQUE ("email"), CONSTRAINT "REL_60523794271ca8bcaf8b541815" UNIQUE ("userId"), CONSTRAINT "PK_60523794271ca8bcaf8b5418155" PRIMARY KEY ("userId"))`, undefined);
        await queryRunner.query(`CREATE TABLE "lock" ("userId" character varying NOT NULL, "reason" character varying, "by" character varying, "until" TIMESTAMP NOT NULL, "at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "REL_61bfb84bece9a15a97cafc2f2f" UNIQUE ("userId"), CONSTRAINT "PK_61bfb84bece9a15a97cafc2f2fa" PRIMARY KEY ("userId"))`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "confirmation" DROP CONSTRAINT "FK_74f1ebea7c18510697c0e2a6be4"`, undefined);
